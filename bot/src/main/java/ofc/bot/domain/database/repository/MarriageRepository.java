...
public class MarriageRepository extends Repository<Marriage> {
    ...
    public List<MarriageView> viewByUserId(long userId, int limit) {
        ...
        Result<?> rels = ctx.select(
                        ...
                        req.field(USERS.AVATAR_HASH).as("req_avatar_hash"),
                        req.field(USERS.IS_BOT).as("req_is_bot"),
                        ...
                        tar.field(USERS.AVATAR_HASH).as("tar_avatar_hash"),
                        tar.field(USERS.IS_BOT).as("tar_is_bot"),
