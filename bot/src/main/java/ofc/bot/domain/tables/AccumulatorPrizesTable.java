...
public class AccumulatorPrizesTable extends InitializableTable<AccumulatorPrize> {
    ...
    public final Field<Integer> AMOUNT               = newField("amount", INT);
    ...
    public final Field<Long> COLOR_DURATION_SECONDS  = newField("color_duration_seconds", BIGINT);
    public final Field<Long> APPROVED_BY             = newField("approved_by", BIGINT);
    public final Field<Long> APPROVED_AT             = newField("approved_at", BIGINT);
    public final Field<Long> REJECTED_BY             = newField("rejected_by", BIGINT);
    public final Field<Long> REJECTED_AT             = newField("rejected_at", BIGINT);
    public final Field<String> LAST_ERROR            = newField("last_error", CHAR);
