...
public class GameMafiaLogsTable extends InitializableTable<GameMafiaLog> {
    ...
    public final Field<String> MATCH_ID     = newField("match_id",       SQLDataType.VARCHAR(255).notNull());
    public final Field<Long> GUILD_ID       = newField("guild_id",       SQLDataType.BIGINT.notNull());
    public final Field<String> EVENT_TYPE   = newField("event_type",     SQLDataType.VARCHAR(255).notNull());
    public final Field<String> ACTION       = newField("action",         SQLDataType.VARCHAR(255).notNull());
    public final Field<Long> ACTOR_USER_ID  = newField("actor_user_id",  SQLDataType.BIGINT.nullable(true));
    public final Field<Long> TARGET_USER_ID = newField("target_user_id", SQLDataType.BIGINT.nullable(true));
    public final Field<Long> CHANNEL_ID     = newField("channel_id",     SQLDataType.BIGINT.nullable(true));
    public final Field<String> PHASE        = newField("phase",          SQLDataType.VARCHAR(255).nullable(true));
