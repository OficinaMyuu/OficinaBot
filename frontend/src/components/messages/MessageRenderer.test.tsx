...
describe('MessageRenderer', () => {
  it('renders edited, referenced, and sticker message metadata', () => {
    render(<MessageRenderer messages={[message({ is_edited: true, message_reference_id: '100', sticker_id: '200' })]} />)
  ...
  it('renders deleted message state without dropping audit context', () => {
    ...
    expect(screen.getByText(/message deleted|mensagem apagada/i)).toBeInTheDocument()
