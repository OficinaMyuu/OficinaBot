...
public class NicknameUpdateRequestsTable extends InitializableTable<NicknameUpdateRequest> {
    ...
    public final Field<String> REQUEST_ID             = newField("request_id",               CHAR.notNull());
    ...
    public final Field<Long> TARGET_USER_ID           = newField("target_user_id",           BIGINT.notNull());
    public final Field<Long> SUBMITTED_BY_ID          = newField("submitted_by_id",          BIGINT.notNull());
    public final Field<String> NICKNAME               = newField("nickname",                 CHAR.notNull());
    public final Field<String> APPROVE_BUTTON_ID      = newField("approve_button_id",        CHAR.notNull());
    public final Field<String> REJECT_BUTTON_ID       = newField("reject_button_id",         CHAR.notNull());
    public final Field<String> STATUS                 = newField("status",                   CHAR.notNull());
    public final Field<Long> DECISION_AUTHOR_ID       = newField("decision_author_id",       BIGINT);
    public final Field<Long> DECIDED_AT               = newField("decided_at",               BIGINT);
    public final Field<String> EMOJI_APPROVAL_SUMMARY = newField("emoji_approval_summary",   CHAR);
    public final Field<String> UNAUTHORIZED_SUMMARY   = newField("unauthorized_summary",     CHAR);
